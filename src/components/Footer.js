...
function Footer() {
  ...
  <TableFooter style ={{width:"100%",display:"block" }}>
    <Box className="main-footer" style ={{color:"white", backgroundColor:"#D0FFD6",padding:"1em 0 1em 0",display:"flex"}}>
         

          <Box className ="col">
            <h4 style={{padding:"0.5em 0 0.5em 0"}}>¿Medios de Pago? </h4>
            <button style={{color:"white",backgroundColor:"#B1CC74", borderColor:"#B1CC74"}}>ver mas</button>
          </Box>
